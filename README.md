...
This is a Command Line Interface (CLI) application that simulates an ATM interaction with a retail bank. It allows users to perform various banking operations, including deposits, withdrawals, and transfers. The system ensures proper validation, debt handling, and session management.
